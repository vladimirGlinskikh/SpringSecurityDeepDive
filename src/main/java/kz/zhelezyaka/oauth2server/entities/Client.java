...
public class Client {
    ...
    @OneToMany(mappedBy = "client", fetch = FetchType.EAGER)
    private List<GrandType> grandTypes;
    ...
    public static RegisteredClient fromClient(Client client) {
        return RegisteredClient.withId(String.valueOf(client.getId()))
                ...
                .authorizationGrantTypes(authorizationGrantTypes(client.getGrandTypes()))
    ...
    private static Consumer<Set<AuthorizationGrantType>> authorizationGrantTypes(List<GrandType> grandTypes) {
        return s -> {
            for (GrandType g : grandTypes) {
